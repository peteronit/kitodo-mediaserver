...
import org.kitodo.mediaserver.core.api.processors.XsltMetsReader;
...
public class XsltMetsReaderTest {
    ...
    public void init() {
        ...
        xsltMetsReader.setXsltFile(xsltFile);

        testMetsFile = new File(classLoader.getResource("mets/flugblatt_test_mets.xml").getFile());
    }
    ...
    public void throwExceptionWhenXsltFileNull() throws Exception {
        xsltMetsReader.setXsltFile(null);
        xsltMetsReader.read(null);
    }

    @Test(expected = ConfigurationException.class)
    public void throwExceptionWhenXsltFileMissing() throws Exception {
        xsltMetsReader.setXsltFile(new File("/tmp"));
        xsltMetsReader.read(null);
    }
